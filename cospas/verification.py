...
Original file is located at
    https://colab.research.google.com/drive/1n18KAbxO_1_9LQtVEk7oCE2kYsJl8Dwd
"""
...
binary_values = []
for i in range(starting_point, starting_point +53520, 120):  # with 40 samples making a bit it needs nearly 12000 samples , 40*144
    if i + 120 > len(data):
        break
...
if len(binary_values)>=431: # check we have sufficcient data 144 = msg, 400 = mag+mac
